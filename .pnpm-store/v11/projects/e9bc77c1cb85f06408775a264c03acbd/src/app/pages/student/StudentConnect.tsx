    ...
    <div className="space-y-6">
      ...
      {suggestions.length === 0 ? (
        <div className="rounded-2xl border border-border/70 bg-card p-10 text-center shadow-sm">
          ...
          <p className="font-medium text-foreground">No co-attendance matches in the current roster</p>
          <p className="mt-1 text-sm text-muted-foreground">
            {attended_past_events.length === 0
              ? "Attend at least one event to unlock this list."
              : "No other students share your attended events yet. Try another account or refresh the roster."}
          </p>
        </div>
      ) : (
        <div className="space-y-4">
