    ...
    <div className="mx-auto max-w-7xl space-y-6">
      <div className="flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
        ...
        <button
          ...
          className="inline-flex items-center gap-2 rounded-xl bg-primary px-4 py-2.5 text-white shadow-sm transition-colors hover:bg-[#5B219F]"
        >
      ...
      <div className="space-y-4 rounded-2xl border border-[#DFD6F1] bg-white p-6 shadow-sm">
        <div className="relative">
          ...
          <input
            ...
            className="w-full rounded-xl border border-[#D8CDED] bg-[#FBF8FF] py-3 pl-10 pr-4 focus:border-[#2F036C] focus:outline-none focus:ring-2 focus:ring-[#2F036C]/20"
          />
        </div>
        ...
        <div className="flex flex-wrap gap-3">
          ...
          <select
            ...
            className="rounded-xl border border-[#D8CDED] bg-[#FBF8FF] px-3 py-2 text-sm focus:border-[#2F036C] focus:outline-none focus:ring-2 focus:ring-[#2F036C]/20"
          >
            ...
            <button
              ...
              className={`px-3 py-1.5 rounded-full text-sm font-medium transition-colors ${
                selectedTags.includes(tag)
                  ? "bg-[#2F036C] text-white shadow-sm"
                  : "bg-[#F4ECFF] text-[#2F036C] hover:bg-[#F1E7FD]"
              }`}
            >
              {tag}
            </button>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        {loading
          ? Array.from({ length: 6 }, (_, index) => (
              <div
                key={index}
                className="animate-pulse rounded-2xl border border-[#DFD6F1] bg-white p-6 shadow-sm"
              >
          ...
          : filteredOpportunities.map((opportunity) => (
              <div
                ...
                className={`rounded-2xl border bg-white p-6 shadow-sm transition-shadow hover:shadow-md cursor-pointer ${selectedOpportunityName === opportunity.name ? "border-[#2F036C] ring-2 ring-[#2F036C]" : "border-[#DFD6F1]"}`}
              >
                <div className="flex items-start justify-between mb-4">
                  ...
                  <span className="rounded-full bg-[#EEE9FB] px-3 py-1 text-xs font-medium text-[#2F036C]">
                    {opportunity.type}
                  </span>
                </div>
                ...
                <div className="mb-4">
                  ...
                  <span className="inline-flex rounded-full bg-[#F4ECFF] px-3 py-1 text-sm font-medium text-[#2F036C]">
                    {opportunity.role}
                  </span>
                </div>
                ...
                <div className="mb-6">
                  ...
                  <div className="flex flex-wrap gap-2">
                    {opportunity.tags.map((tag) => (
                      <span
                        key={tag}
                        className="rounded-md bg-[#F7F0FF] px-2 py-1 text-xs text-[#2F036C]"
                      >
                        {tag}
                      </span>
                    ))}
                ...
                <div className="flex items-center gap-3">
                  <button
                    ...
                    className="flex-1 rounded-xl bg-primary px-4 py-2.5 font-medium text-white shadow-sm transition-colors hover:bg-[#5B219F]"
                  >
                    Match Volunteers
                  </button>
                  {opportunity.url ? (
                    <a
                      ...
                      target="_blank"
                      rel="noreferrer"
                      className="rounded-xl border border-[#D8CDED] px-4 py-2.5 text-gray-700 transition-colors hover:bg-[#FBF8FF]"
                    >
      ...
      {!loading && !error && filteredOpportunities.length === 0 ? (
        <div className="rounded-2xl border border-[#DFD6F1] bg-white p-10 text-center text-gray-600 shadow-sm">
