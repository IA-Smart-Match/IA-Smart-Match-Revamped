 ...
 *
 * This page used to load your attendance history from the legacy `/api/portals/*` backend.
  ...
  return (
    <div className="space-y-6">
      <header className="space-y-1">
        ...
        <p className="text-sm text-muted-foreground">What you have attended, and what it earned.</p>
      ...
      <div className="space-y-4">
        <PortalDatasetUnavailable
          dataset="Your attendance history"
          endpoints={["/api/portals/students/{id}/registrations", "/api/portals/students/{id}"]}
        />
      </div>
    </div>
  );
