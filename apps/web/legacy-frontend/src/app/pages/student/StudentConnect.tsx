 ...
 *
 * This page used to load connection suggestions from the legacy `/api/portals/*` backend.
  ...
  return (
    <div className="space-y-6">
      <header className="space-y-1">
        ...
        <p className="text-sm text-muted-foreground">People to meet, based on what you have attended.</p>
      ...
      <div className="space-y-4">
        <PortalDatasetUnavailable
          dataset="Connection suggestions"
          endpoints={["/api/portals/student-connections", "/api/portals/students/{id}/connection-suggestions"]}
        />
      </div>
    </div>
  );
