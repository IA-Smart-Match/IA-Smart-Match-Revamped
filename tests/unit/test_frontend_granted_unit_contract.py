"""The three unit-scoped hooks read the unit the *server* granted.
...
``useOutreach``, ``useSpeakerInvitations`` and ``useRewards`` each resolved their
...
OUTREACH_HOOK = HOOKS / "useOutreach.ts"
INVITATIONS_HOOK = HOOKS / "useSpeakerInvitations.ts"
...
UNIT_SCOPED_HOOKS = (
    (OUTREACH_HOOK, "useOutreach(unitId: string | null)"),
    (INVITATIONS_HOOK, "useSpeakerInvitations(unitId: string | null)"),
    (REWARDS_HOOK, "useRewards(unitId: string | null)"),
)

#: Every call site of the three, and the portal each resolves its grant for.
UNIT_SCOPED_CALLERS = (
    (COORDINATOR_OUTREACH, "coordinator"),
...
@pytest.mark.parametrize(
    ("path", "constant"),
    (
        (OUTREACH_HOOK, "OUTREACH_NO_UNIT_REASON"),
        (INVITATIONS_HOOK, "INVITATIONS_NO_UNIT_REASON"),
...
@pytest.mark.parametrize(
    ("path", "constant"),
    (
        (COORDINATOR_OUTREACH, "OUTREACH_NO_UNIT_REASON"),
        (COORDINATOR_OUTREACH, "INVITATIONS_NO_UNIT_REASON"),
