...
PAGED_SURFACES: dict[str, tuple[str, ...]] = {
    ...
    "coordinator/CoordinatorEvents.tsx": ("events",),
...
LATE_WIRED_SURFACES: tuple[tuple[str, str, str], ...] = (
    ("coordinator/CoordinatorEvents.tsx", "events", "visibleEvents"),
...
def test_the_late_wired_pages_keep_the_servers_notice_distinct() -> None:
    ...
    """
    server_capped_surfaces = LATE_WIRED_SURFACES[1:]
    for relative_path, _array, _visible in server_capped_surfaces:
