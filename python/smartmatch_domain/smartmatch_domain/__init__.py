...
This package has **no dependencies** — not FastAPI, SQLAlchemy, provider SDKs,
the filesystem, the network, or environment variables. That is enforced in CI by
the import-linter contracts in the root ``pyproject.toml``, not by convention.
