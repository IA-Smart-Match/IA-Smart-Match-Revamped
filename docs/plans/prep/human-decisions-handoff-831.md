...
**Current human fact for this handoff:** Yes — Git: @BrooklynD23.
...
- **T-19:** approver is @BrooklynD23; proposer is the same human plus
...
| **T-19** | approver is @BrooklynD23; proposer is the same human plus Chau / Starey Night (Janice) and the relevant agents |
...
- **P7 D6/D7 rewards** — needs both the owner from §1 *and* a funding decision.
  Working direction: owner is @BrooklynD23; rewards should be capped at a
...
- **CP-PII — legacy PII remediation.** Six paths of real people's data live in
  ...
  **Current disposition for this handoff:** the source repo is archived and
  ...
  (`Git: @BrooklynD23`). Access is removed from everyone, and this issue
