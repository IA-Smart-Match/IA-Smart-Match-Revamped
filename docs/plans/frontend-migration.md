...
| H27 | `VolunteerProfile.tsx` entire page | Fatigue % and recovery are displayed; there is no editor for availability or workload inputs. | Professionals must see *and correct* the data used about them (DESIGN.md §1.6, R2 self-service). **DECIDED 2026-09-22 (owner): option B — build self-service availability; plan at [`2026-09-22-b26-self-service-availability-plan.md`](2026-09-22-b26-self-service-availability-plan.md).** The person ELI and matching measure is a Speaker (a contact record), not the Event Host this page serves; the plan's owner question Q2 settles which surface a Speaker edits from. |
...
| `eli.py` | Proposed ELI formula | Volunteer fatigue UI must wait on D2 + R2 self-service. R2 self-service: DECIDED 2026-09-22 (owner): option B — build self-service availability; plan at [`2026-09-22-b26-self-service-availability-plan.md`](2026-09-22-b26-self-service-availability-plan.md). D2's committed-vs-completed sub-question is still **OPEN**, and `eli.py` has no caller outside its tests. |
...
| Task | Detail | Depends | Acceptance |
|---|---|---|---|
| 6.1 | Professional profile **edit** of availability/workload used by ELI. DECIDED 2026-09-22 (owner): option B — build self-service availability; plan at [`2026-09-22-b26-self-service-availability-plan.md`](2026-09-22-b26-self-service-availability-plan.md). | D2 (sub-question still OPEN — gates the ELI track only), plan owner question Q2 (who edits) | §1.6 satisfied. |
