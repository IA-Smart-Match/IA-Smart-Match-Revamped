...
> **Superseded — 27 August 2026.** The branch this document plans the merge of,
> `claude/pr1-blockers-todos-er5heu`, merged as **PR #3** (`9865bf3`). The
> checklist below was not executed from this document; the work was carried out
> and evidenced on the branch itself. Read this as the record of what was
> intended, and `docs/plans/pr3-verification-evidence.md` on `main` for what was
> actually run and what could not be verified. **Do not execute this checklist.**
