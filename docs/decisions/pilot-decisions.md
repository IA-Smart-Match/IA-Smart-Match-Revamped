...
| **D2** | ELI formula parameters (decay half-life, window, caps) | The parameters implemented today stand as the tentative values. **Sub-question DECIDED 2026-09-22 (owner):** committed future engagements **do** count, by a centered 90-day utilization: load = (hours completed in the last 45 days + hours **confirmed** in the next 45 days) ÷ declared capacity hours per 90 days. A cancelled booking drops out immediately. Load is banded for scoring: Light < 50% no penalty; Moderate 50–80% small penalty; Heavy 80–100% large penalty; Full > 100% filtered out at Stage A. No horizon or weight parameter; the recency decay in `eli.py` is replaced. B26 (same day): DECIDED 2026-09-22 (owner): option B — build self-service availability; plan at [`docs/plans/2026-09-22-b26-self-service-availability-plan.md`](../plans/2026-09-22-b26-self-service-availability-plan.md), track T8. | The band penalty sizes and boundary ownership (plan §9, the one open owner question), approval of the new registry version they produce, and IA West confirmation of the rule. |
