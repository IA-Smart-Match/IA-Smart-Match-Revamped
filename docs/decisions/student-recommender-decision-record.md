...
| 4 | **Multi-stakeholder constrained re-rank** — bounded feed, diversity preference, declared wildcard, governance counts, later capacity | **Always on.** Stage C wraps #1 and #2 from the first version; needs no behavioural data | OQ-SE-02 (wildcard contract) |
