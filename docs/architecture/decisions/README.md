...
| [ADR-0018](ADR-0018-speaker-roster-and-invitation-tracking.md) | Speaker roster and invitation tracking | Accepted | 8 September 2026 | Smart Match tracks a published speaker roster and speaker-event status history while email remains outside the platform. | — | — | — |
...
**ADR-0019 is reserved** for agent-memory Slice 1
